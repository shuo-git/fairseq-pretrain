...
@dataclass
class SentencePredictionTransformerConfig(FairseqDataclass):
...
@register_task("sentence_prediction_transformer", dataclass=SentencePredictionTransformerConfig)
class SentencePredictionTransformerTask(FairseqTask):
    """
    Sentence (or sentence pair) prediction (classification or regression) task for Transformer Language Models.
